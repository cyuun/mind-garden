...
namespace GracesGames.SimpleFileBrowser.Scripts {
	...
	public class FileBrowser : MonoBehaviour {
		...
		public event Action<string> OnFileSelect = SelectMusic;
		public static void SelectMusic(string url)
		{
			MenuController.S.ChangeMusic(url);
		}
		...
		private void SetupPath(string startPath) {
			if (!String.IsNullOrEmpty(startPath) && Directory.Exists(startPath)) {
				...
				_currentPath = Application.dataPath + "/Songs";
			}
		}
