        ...
        private void Update()
        {
            ...
            if (canRotate && snapLeftAction != null && snapRightAction != null && snapLeftAction.activeBinding && snapRightAction.activeBinding)
            {
               ...
               // if (Time.time < (teleportLastActiveTime + canTurnEverySeconds))
                ...
                bool leftHandTurnLeft = snapLeftAction.GetState(SteamVR_Input_Sources.LeftHand);
                bool rightHandTurnLeft = snapLeftAction.GetState(SteamVR_Input_Sources.RightHand);

                bool leftHandTurnRight = snapRightAction.GetState(SteamVR_Input_Sources.LeftHand);
                bool rightHandTurnRight = snapRightAction.GetState(SteamVR_Input_Sources.RightHand);

                bool leftHandforward = forward.GetState(SteamVR_Input_Sources.LeftHand);
                bool rightHandforward = forward.GetState(SteamVR_Input_Sources.RightHand);

                bool leftHandbackward = backward.GetState(SteamVR_Input_Sources.LeftHand);
                bool rightHandbackward = backward.GetState(SteamVR_Input_Sources.RightHand);
