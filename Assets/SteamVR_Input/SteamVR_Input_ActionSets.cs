...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_mindsGarden p_mindsGarden;
        ...
        public static SteamVR_Input_ActionSet_mindsGarden mindsGarden
        {
            get
            {
                return SteamVR_Actions.p_mindsGarden.GetCopy<SteamVR_Input_ActionSet_mindsGarden>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_mindsGarden = ((SteamVR_Input_ActionSet_mindsGarden)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_mindsGarden>("/actions/mindsGarden")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.mindsGarden};
        }
    }
}
