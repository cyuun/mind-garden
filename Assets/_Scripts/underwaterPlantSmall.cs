...
public class underwaterPlantSmall : Tree
{
    ...
    void Update()
    {
        Vector3 vec1 = new Vector3(0.01f, 0.01f, 0.0085f+(Mathf.Sin(Time.time * (mainMusicVariable+ 0.01f)) * 0.0009f));
        Vector3 vec2 = new Vector3(0.01f, 0.01f, 0.008f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.08f)) * 0.001f));
        Vector3 vec3 = new Vector3(0.01171215f, 0.01171215f, 0.01f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.04f)) * -0.001f));
        Vector3 vec4 = new Vector3(0.01f, 0.01f, 0.0085f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.012f)) * 0.001f));
        Vector3 vec5 = new Vector3(-0.01171215f, -0.01171215f, -0.01f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.06f)) * 0.001f));

        Vector3 vec6 = new Vector3(0.00649583f, 0.00649583f, 0.004f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.08f)) * 0.001f));
        Vector3 vec7 = new Vector3(-0.00649583f, -0.00649583f, -0.005f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.04f)) * 0.001f));
        Vector3 vec8 = new Vector3(0.00649583f, 0.00649583f, 0.0045f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.012f)) * 0.001f));
        Vector3 vec9 = new Vector3(-0.00649583f, -0.00649583f, -0.0045f + (Mathf.Sin(Time.time * (mainMusicVariable + 0.06f)) * 0.001f));
